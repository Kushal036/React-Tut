...
function BlogCard({image , title , content ,newsLink , sourse}) {
  ...
  return (
    <div className="mx-auto max-w-md overflow-hidden rounded-xl bg-gray-400 shadow-md md:max-w-6xl my-5 border-2">
  <div className="md:flex">
    ...
    <div className="p-8">
      ...
      <h2 className="mt-1 block text-lg leading-tight font-medium text-black hover:underline cursor-pointer">
        {title}
      </h2>
