...
function Header() {
  return (
    <div className='flex mx-auto w-fit items-center justify-between h-20 px-4  rounded-2xl text-black mt-5 border-b-2'> 
      ...
      <div className='flex gap-3 pl-4'>
        ...
        <NavLink to='/' className={({isActive}) =>
                                    `${isActive ? "text-orange-500":"text-black" } p-3 rounded-3xl  border-transparent border-2 hover:text-gray-900 hover:scale-130   transition duration-300 ease-in-out flex items-center text-center font-bold` 
                                    } >
        Home
        </NavLink>
        <NavLink to='/counter' className={({isActive}) =>
                                    `${isActive ? "text-orange-500":"text-black" } p-1 rounded-3xl  border-transparent border-2 hover:text-gray-900 hover:scale-130   transition duration-300 ease-in-out flex items-center text-center font-bold`
                                    } >
        Counter
        </NavLink>
